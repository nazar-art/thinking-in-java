...
public class E25_AllocateDirect {
    public static void main(String[] args) {
                ...
                new CompareAllocations("GetChannel", 8192) {
                    ...
                    public void execute() throws IOException {
                        FileChannel fc = new FileInputStream(
                                "./src/io/E25_AllocateDirect.java")
                                .getChannel();
                        fc.read(buffer);
                        buffer.flip();
        ...
        }, new CompareAllocations("./src/io/BufferToText", 8192) {

            @SuppressWarnings("resource")
            public void execute() throws IOException {
                FileChannel fc = new FileOutputStream(
                        "./src/io/data2.txt").getChannel();
        ...
        }, new CompareAllocations("./src/io/GetData", 1024) {
        ...
        }, new CompareAllocations("./src/io/IntBufferDemo", 1024) {
        ...
        }, new CompareAllocations("./src/io/UsingBuffers", 32) {
