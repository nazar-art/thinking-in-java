...
//{Args: ./src/net.lelyak.enumerated/VendedItems.txt ./src/net.lelyak.enumerated/VendingMachineInput.txt}
/****************** Exercise 11 *****************
 ...
 * net.lelyak.mindview.util.TextFile).
 ***********************************************/
...
enum Category2 {
    MONEY(Input2.NICKEL, Input2.DIME, Input2.QUARTER, Input2.DOLLAR), ITEM_SELECTION(
            Input2.VENDED_ITEM), QUIT_TRANSACTION(Input2.ABORT_TRANSACTION), SHUT_DOWN(
            Input2.STOP);
...
// Create Inputs from a file of ';'-separated net.lelyak.strings:
