...
// Displays @Unit net.lelyak.annotations in compiled class files. If
// first argument is "-r", @Unit net.lelyak.annotations are removed.
// {Args: ..}
// {Requires: javassist.bytecode.ClassFile;
// You must install the Javassist library from
// http://sourceforge.net/projects/jboss/ }
package net.lelyak.mindview.atunit;

import net.lelyak.mindview.util.ProcessFiles;
        ...
        try {
            ...
            for(CtMethod method : ctClass.getDeclaredMethods()) {
                ...
                for(Annotation ann : attr.getAnnotations()) {
                    if(ann.getTypeName()
                            .startsWith("net.lelyak.mindview.atunit")) {
