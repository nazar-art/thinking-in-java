package net.lelyak.courses.maze;
...
class MyMazeImpl {
    ...
    public MyMazeImpl(int aDimension) {
        // Initialize
        this(aDimension, aDimension);
    }

    // constructor
    public MyMazeImpl(int xDimension, int yDimension) {
...
public class MyMazeDemo {
    public static void main(String[] args) {
        MyMazeImpl maze = new MyMazeImpl(20);
        maze.solve();
        maze.draw();

        System.out.println();
        maze = new MyMazeImpl(15, 10);
        maze.solve();
        maze.draw();

        System.out.println();
        maze = new MyMazeImpl(30, 10);
        maze.solve();
        maze.draw();
    }
}
