...
//: net.lelyak.typeinfo/FamilyVsExactType.java
...
public class FamilyVsExactType { //1st - base
...
Testing x of type class net.lelyak.typeinfo.Base
...
Testing x of type class net.lelyak.typeinfo.Derived
x instanceof Base true
