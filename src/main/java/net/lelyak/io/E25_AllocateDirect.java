...
abstract class CompareAllocations {
    ...
    public void runComparison() {
        ...
        try {
            ...
            System.out.println("Direct Allocation Cost for buffer of size: <"
                    + size + "> is <" + (endTime - startTime) + ">");
            startTime = System.nanoTime();
            execute();
            endTime = System.nanoTime();
            System.out.println("Execution cost using direct buffer: <"
                    + (endTime - startTime) + ">");
            startTime = System.nanoTime();
            indirectAllocate();
            endTime = System.nanoTime();
            ...
            execute();
            endTime = System.nanoTime();
            System.out.println("Execution cost using indirect buffer: <"
                    + (endTime - startTime) + ">");
        } catch (IOException e) {
...
public class E25_AllocateDirect {
    public static void main(String[] args) {
        ...
        CompareAllocations[] comparisons = {
                new CompareAllocations("GetChannel", 8192) {
                    ...
                    public void execute() throws IOException {
                        FileChannel fc = new FileInputStream(
                                "./src/net.lelyak.io/E25_AllocateDirect.java")
                                .getChannel();
                        fc.read(buffer);
                        buffer.flip();
            ...
            public void execute() throws IOException {
                FileChannel in = new FileInputStream(
                        "./src/net.lelyak.io/E25_AllocateDirect.java")
                        .getChannel(), out = new FileOutputStream(
                        "./src/net.lelyak.io/temp.txt").getChannel();
        ...
        }, new CompareAllocations("./src/net.lelyak.io/BufferToText", 8192) {

            @SuppressWarnings("resource")
            public void execute() throws IOException {
                FileChannel fc = new FileOutputStream(
                        "./src/net.lelyak.io/data2.txt").getChannel();
                fc.write(ByteBuffer.wrap("Some text".getBytes()));
                fc.close();
                fc = new FileInputStream("./src/net.lelyak.io/data2.txt").getChannel();
                fc.read(buffer);
                buffer.flip();
                ...
                Charset.forName(System.getProperty("file.encoding"))
                        .decode(buffer);
                fc = new FileOutputStream("./src/net.lelyak.io/data2.txt")
                        .getChannel();
                fc.write(ByteBuffer.wrap("Some text"
                        .getBytes("UTF-16BE")));
                fc.close();
                // Now try reading again:
                fc = new FileInputStream("./src/net.lelyak.io/data2.txt")
                        .getChannel();
                buffer.clear();
                fc.read(buffer);
                buffer.flip();
        ...
        }, new CompareAllocations("./src/net.lelyak.io/GetData", 1024) {
        ...
        }, new CompareAllocations("./src/net.lelyak.io/IntBufferDemo", 1024) {
        ...
        }, new CompareAllocations("./src/net.lelyak.io/UsingBuffers", 32) {
