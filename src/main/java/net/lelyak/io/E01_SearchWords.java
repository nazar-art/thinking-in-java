 ...
 *	opens and reads each file (using the net.lelyak.mindview.util.TextFile utility) and accepts the
...
import net.lelyak.mindview.util.TextFile;
...
public class E01_SearchWords {
    ...
    public static void main(final String[] args) {
        File path = new File("./src/net.lelyak.io");
        String[] list;
        if (args.length == 0)
            list = path.list();
        else
