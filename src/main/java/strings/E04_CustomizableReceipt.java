...
class ReceiptNew {
	...
	private static final String TITLE_FRMT = "%-" + ITEM_WIDTH + "s %"
			+ QTY_WIDTH + "s %" + PRICE_WIDTH + "s\n";
	private static final String ITEM_FRMT = "%-" + ITEM_WIDTH + "."
			+ ITEM_WIDTH + "s %" + QTY_WIDTH + "d %" + PRICE_WIDTH + ".2f\n";
	private static final String TOTAL_FRMT = "%-" + ITEM_WIDTH + "s %"
			+ QTY_WIDTH + "s %" + PRICE_WIDTH + ".2f\n";
...
public class E04_CustomizableReceipt {
	public static void main(String[] args) {
		ReceiptNew receipt = new ReceiptNew();
		receipt.printTitle();
